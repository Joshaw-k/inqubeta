...
export default function Home() {
  return (
    <div className="flex justify-center items-center flex-col min-h-[100vh] bg-[url('/hero-bg.png')] bg-cover bg-bottom">
            ...
            <div className="relative flex w-full p-5 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left subpixel-antialiased overflow-hidden z-10">
              ...
              <form className="flex flex-col gap-4">
                  ...
                  >
                    ...
                    <div className="inline-flex h-full items-center w-full gap-1.5 box-border bg-transparent">
                      <svg
                        ...
                        fill="currentColor"
                        aria-hidden="true"
                        class="text-[#00B7FF]/60 w-4 h-4 dark:text-[#00B7FF]/60 pointer-events-none flex-shrink-0"
                      >
                    ...
                    <div className="inline-flex h-full items-center w-full gap-1.5 box-border bg-transparent">
                      ...
                      <button class="focus:outline-none" type="button">
                        <svg
                          ...
                          viewBox="0 0 24 24"
                          width="1em"
                          class="text-xl text-[#00B7FF]/60 dark:text-[#00B7FF]/60  pointer-events-none"
                        >
                          <path
                ...
                <div class="flex  justify-between">
                  <label class="group relative max-w-fit items-center justify-start tap-highlight-transparent p-2 -m-2 inline-flex cursor-pointer">
                    <div
                      style={{
                        border: 0,
                        clip: "rect(0 0 0 0)",
                    ...
                    <span
                      id=":R1mdbbadda:"
                      class="relative select-none text-sm transition-colors-opacity before:transition-width motion-reduce:transition-none w-full text-black"
                    >
                      Remember me
                    </span>
                  </label>
                  <a class="text-sm text-black" href="/forget-password">
                    Forget Password?
                  </a>
                </div>
                <p class="text-center text-sm text-black">
                  Need to create an account?{" "}
                  <a class="cursor-pointer text-[#00B7FF]" href="#">
                    Sign up
                  </a>
                </p>
              </form>
      ...
      <div class="flex flex-col items-center mx-auto py-2 md:py-3 text-white">
        <div class="flex flex-col justify-center text-center">
          <a class="text-sm hover:text-primary/70">Privacy Policy</a>
          <a class="text-sm hover:text-primary/70">Terms and Conditions</a>
        </div>
        <div class="py-1">
          <span class="text-sm">© 2024 InQubeta. All Rights Reserved.</span>
        </div>
      </div>
    </div>
  );
